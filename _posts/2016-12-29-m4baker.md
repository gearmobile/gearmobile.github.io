...
Я протестировал приложение m4Baker на рабочей машине ( Linux Mint 18 Cinnamon ). Файлы mp3-формата аудиокниги были успешно сконвертированы в файл формата m4b. На всех устройствах ( Linux Desktop, Android ) данный файл успешно прослушивался.

Приложение m4Baker можно и нужно использовать для создания аудиокниг формата m4b под операционной системой Linux.
...
На этом все. Все удачного Нового Года!
