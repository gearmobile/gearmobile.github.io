...
![Stellar.js - parallax scrolling with jQuery]({{site.url}}/images/uploads/2014/11/stellar.png)

Готовый Live-Demo пример parallax scrolling на Stellar.js можно посмотреть здесь - [Stellar.js][9].
