...
Итогом всех вышеперечисленных умозаключений является следующая последовательность шагов. Заходим, как было уже сказано, на [страницу][2] и видим там три больших раздела: "Version", "Components", "Theme". В первом разделе "Version" выбирается версия библиотеки jQuery. На момент написания статьи это `v.1.10.3`. Это нас устраивает, поэтому оставляем все как есть.
...
Для этого нужно перейти по ссылке [API documentation][1], где представлен список опций, методов и событий для меню аккордеон на jQuery UI. Нас интересует одна из опций - heightStyle, которая может принимать три значения:
...
![Меню аккордеон с опцией heightStyle: fill]({{site.url}}/images/uploads/2013/10/jquery-ui_heightStyle-fill.jpg)

![Меню аккордеон с опцией heightStyle: content]({{site.url}}/images/uploads/2013/10/jquery-ui_heightStyle-content.jpg)
...
[1]: http://api.jqueryui.com/accordion/ "Accordion"
[2]: http://jqueryui.com/download/ "Download"
