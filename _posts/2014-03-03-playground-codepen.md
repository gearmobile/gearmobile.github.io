...
![Главная страница CodePen]({{site.url}}/images/uploads/2014/03/codepen-main.jpg)
...
![Доступ к личному профилю на CodePen]({{site.url}}/images/uploads/2014/03/codepen-settings.jpg)
...
![Настройки CodePen]({{site.url}}/images/uploads/2014/03/codepen-profile-settings.jpg)
...
![JavaScript библиотека Prefix Free]({{site.url}}/images/uploads/2014/03/codepen-prefix_free.jpg)
...
![Окно быстрых настроек CSS в CodePen]({{site.url}}/images/uploads/2014/03/codepen-quick_settings.jpg)
...
![Выбираем CSS-препроцессор в CodePen]({{site.url}}/images/uploads/2014/03/codepen-quick_select_preprocessor.jpg)
...
![Основное окно CodePen]({{site.url}}/images/uploads/2014/03/codepen-pen.jpg)
...
![Информация о проекте на CodePen]({{site.url}}/images/uploads/2014/03/codepen-info.jpg)
...
![Публичная ссылка в CodePen]({{site.url}}/images/uploads/2014/03/codepen-share.jpg)
...
![Встраивание CodePen в другой проект]({{site.url}}/images/uploads/2014/03/codepen-embed.jpg)
...
![Распахиваем окно кода в CodePen]({{site.url}}/images/uploads/2014/03/codepen-expand_pen.jpg)

А щелчок мыши на самой надписи CSS переводит окно в **режим компиляции**, то есть перевода SCSS в готовый CSS-код:

![Создание SCSS-кода в CodePen]({{site.url}}/images/uploads/2014/03/codepen-scss.jpg)
...
![Список клавиатурных сокращений в CodePen]({{site.url}}/images/uploads/2014/03/codepen-hotkeyes.jpg)
