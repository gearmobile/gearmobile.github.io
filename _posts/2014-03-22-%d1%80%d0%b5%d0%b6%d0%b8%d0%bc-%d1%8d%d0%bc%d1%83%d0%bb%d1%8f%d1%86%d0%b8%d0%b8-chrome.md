...
<figure id="attachment_1053" style="width: 600px;" class="wp-caption aligncenter">

[<img src="http://localhost:7788/third/wp-content/uploads/2014/03/settings-600x232.png" alt="Режим Settings в браузере Chrome" width="600" height="232" class="size-medium wp-image-1053" />][2]<figcaption class="wp-caption-text">Режим Settings в браузере Chrome</figcaption>

</figure> <figure id="attachment_1054" style="width: 600px;" class="wp-caption aligncenter">[<img src="http://localhost:7788/third/wp-content/uploads/2014/03/emulation_show-600x301.png" alt="Show &#039;Emulation&#039; view in console drawer" width="600" height="301" class="size-medium wp-image-1054" />][3]<figcaption class="wp-caption-text">Show &#8216;Emulation&#8217; view in console drawer</figcaption></figure>
...
<figure id="attachment_1060" style="width: 468px;" class="wp-caption aligncenter">
